						 ...
						 <div  class="panel-heading"><center><h4>Approve Notices</h4><center></div>
						  <div  class="panel-body">
							...
							while($row1=mysqli_fetch_assoc($run1))
							{
								...
								<tr>
								<td> <a  type="button" class="btn btn-primary"  href="verify_notice.php?id=<?php echo $row1['notice_id'];?>&chatid=<?php echo $row3['faculty_chatid'];?>&ap=app"> <span class="	glyphicon glyphicon-ok"></span>  Approve </a></td>
							       <td>  <a type="button"  class="btn btn-primary" href="verify_notice.php?id=<?php echo $row1['notice_id'];?>&chatid=<?php echo $row3['faculty_chatid'];?>&ap=dec"> <span class="	glyphicon glyphicon-remove"></span>  Decline  </a></td>
