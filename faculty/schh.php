...
<div class="row" id="row1">
       <div   class="col-md-6" id="col" >
		<div  class="panel panel-primary ">
			...
			echo"currently there is no conversation. please click on start chat for starting conversation."; 
				 ...
				 ?>
				 <table class="table" style="display:block;overflow:auto;height:52.5%">
				 <tr>
				 <td>
				 ...
				 while($row=mysqli_fetch_assoc($run))
				 {
					...
					<td>
					<center><a class="btn btn-default col-md-12" href="?cid=123456"><h4>Admin</h4>
					<?php  if($check7>0)
					{
						?><span style="float:right" class="badge"><?php echo $check7; ?> </span><?php
					}?>
			 ...
			 <div class="panel-footer">
			  <a class="btn" href="staff_chat.php" >Start New Conversation</a>
			 </div>
		</div>
	   </div>
	   ...
	   <div   class="col-md-6" >
		<div  class="panel panel-primary ">
			...
			?>
				<table class="table" style="display:block;overflow:auto;height:36%">
				<tr>
				 <td>
				 <img src="../images/background4.jpg" />
				 </td>
		 ...
		 <form action="smsgpass.php?id=<?php  echo $id;?>" method="post" enctype="multipart/form-data">
		<table class="table">
		 <tr>
        ...
        <?php 
			...
			?>
			<img src="../images/chat.jpg" class="img-responsive" style="height:63%" />
			<?php
		}
