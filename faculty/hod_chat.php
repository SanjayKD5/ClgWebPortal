		 ...
		 <div  class="panel panel-primary ">
			 <div class="panel-heading"><h4 align="center">Chat</h4> </div>
              <div class="panel-body" id="panel">
			      ...
			      <form method="get" action="hod_chat.php">
				   
					<table class="table " height="44%">
					 <tr>
					 <th> WITH:-</th>
					 </tr>
					    <tr>
				   ...
				   <?php 
					...
					if($check==0)
					{
						...
						while($row=mysqli_fetch_assoc($run))
						{
							...
							<td><a class="btn btn-primary" href="?chatid=<?php echo $row['faculty_chatid'];?>&user=<?php echo $user; ?>&branch=<?php echo $department; ?>&year=<?php echo $year; ?>"  data-toggle="modal" data-target="#myModal">chat</a></td>
							</tr>
...
?>		
		...
		<form action="hmsgpass.php?id=<?php echo $id;?>&user=<?php echo $user; ?>&branch=<?php echo $department; ?>&year=<?php echo $year; ?>" method="post" enctype="multipart/form-data">
		<table class="table">
		 <tr>
