...
$check=mysqli_num_rows($run1);
		 ...
		 <div  class="panel panel-primary ">
			<div class="panel-heading "><h4><center>MANAGE NOTICES</center></h4> </div>
			  ...
			  <table class="table" width="100%">
			    <tr>
				  <td><a href="your_notices.php"><span class="	glyphicon glyphicon-hand-right"></span>  see your uploded notices</a></td>
				</tr>
				<tr>
				  <td><a href="noticeboard.php"><span class="	glyphicon glyphicon-hand-right"></span>  Student Notice Board</a></td>
				</tr>
				<tr>
				  <td><a href="staff_noticeboard.php"><span class="	glyphicon glyphicon-hand-right"></span>  Staff notice Board  <span class="badge"></span></a></td>
				</tr>
				<tr>
				  <td><a href="approved.php"><span class="	glyphicon glyphicon-hand-right"></span>  Approved list <span class="badge"><?php echo $check?></span></a></td>
				</tr>
				<tr>
				  <td><a href="enroll.php"><span class="	glyphicon glyphicon-hand-right"></span> student enroll for notices </a></td>
				</tr>
				<tr>
  ...
  <?php
include("templetes/staff_footer.php");
?>
