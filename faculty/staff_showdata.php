...
//include("templets/staff_check1.php");
$id=$_SESSION['user_id'];
...
$row=mysqli_fetch_assoc($run);
         ...
         <div class="col-md-5">
	       <div class="panel panel-primary">
	         ...
	         <div class="panel-body"> 
	           <img class="img-responsive" src="../images/<?php echo $row['faculty_image'];?>" style="height:47%;width:100%" />
		     </div>
	 ...
	 <div class="col-md-7">
	 <div class="panel panel-primary">
	  <div class="panel-heading"><center><h4>STAFF DETAILS</h4></center></div>
	  <div class="panel-body">
	   <table class="table">
	     <tr>
