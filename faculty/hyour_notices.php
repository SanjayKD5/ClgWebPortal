						 ...
						 <div  class="panel-heading"><center><h4>Your Uploded Notices</h4><center></div>
						  <div  class="panel-body">
							...
							do
							{
								...
								?>
								<tr>
							      <td> <a type="button" href="hviewedby.php?id=<?php echo $row['notice_id']; ?>" class="btn btn-primary"><h4>viewed by <span class="glyphicon glyphicon-eye-open"></span></h4></a></td>
								<td> <a type="button" href="hnotice_operation.php?action=del&id=<?php echo $row['notice_id'];?>" class="btn btn-primary"><h4>Delete notice <span class="glyphicon glyphicon-trash"></span></h4></a></td>
