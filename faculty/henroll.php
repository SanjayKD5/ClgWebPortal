...
<div class="row"  id="row1">
 <div  class="col-md-5" >
			 <div class="panel panel-primary ">
				...
				<form action="henroll.php" method="post">
                ...
                <div class="panel-body" id="enroll" class="collapse">
					...
					<?php
						...
						while($row=mysqli_fetch_assoc($run))
						{
							...
							<td> <a href="hstudent_detail.php?id=<?php echo $sid;?>" > more Details</a></td>
							</tr>
						...
						?>
						<form action="hschedule.php?id=<?php echo $id;?>" method="post">
						<tr >
