<?php
include_once("templetes/check.php");
include("../connection/dbconn.php");
if(!isset($_GET['chatid']))
{
	
include_once("templetes/admin_header.php");
 ...
 <div class="row" id="row1">
       <div   class="col-md-6" id="col" >
		 ...
		 <div  class="panel panel-primary ">
				   ...
				   <?php 
					...
					<?php
						...
						while($row=mysqli_fetch_assoc($run))
						{
							...
							<td><a class="btn btn-primary" href="?chatid=<?php echo $row['faculty_chatid'];?>&user=<?php echo $user; ?>&branch=<?php echo $department; ?>"  data-toggle="modal" data-target="#myModal">chat</a></td>
							</tr>
			...
			?>
			<img src="../images/chat2.jpg" class="img-responsive" style="height:32%" />
			<?php
		}
...
?>
     ...
     <div class="modal-content">
		...
		if(isset($_GET['chatid']))
		{
			...
			$sid="123456";
			$fetch="select * from chat where sender='$id'and reciver='$sid' or sender='$sid'and reciver='$id'order by chat_id  desc  ";
...
?>		
		...
		<form action="msgpass.php?id=<?php echo $id;?>&user=<?php echo $user; ?>&branch=<?php echo $department; ?>" method="post" enctype="multipart/form-data">
		<table class="table">
		 <tr>
